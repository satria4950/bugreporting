...
@section('container') 
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Bug Reporting User</h1>
        </div>
        ...
        <div class="table-responsive col-lg-12">
            <a href="/dashboard/bugreportuser/create" class="btn btn-primary mb-3">Create New Bug Report</a>
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/dashboard/bugreportuser/{{ $bug->slug}}" class="badge bg-info">
                            <span data-feather="eye"></span>
                        </a>
                        <a href="/dashboard/bugreportuser/{{ $bug->slug }}/edit" class="badge bg-warning">
                            <span data-feather="edit"></span>
                        </a>
                        <form action="/dashboard/bugreportuser/{{ $bug->slug }}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
